 ...
 */
public class ScheduledAreaNumberJobHour implements Job {

    static Logger logger = null;

    static {
        PropertyConfigurator.configure("log4j.properties");
        logger = Logger.getLogger(ScheduledAreaNumberJobHour.class.getName());
    }
        ...
        for (Map.Entry<String, Set<String>> entry : configMap.entrySet()) {
            ...
            for (String uli : areaSet) {
                ...
                for (String imsi : baseStation.keySet()) {
                    //统计
                    PersonInfo person = baseStation.get(imsi);
                }
            }
            //汇总统计结果
        }
